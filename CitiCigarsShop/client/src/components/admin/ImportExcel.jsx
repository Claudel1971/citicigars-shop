    ...
    return {
      ...
      promotions: {
        unitaire: {
          actif: rabais > 0,
          pourcentage: rabais,
          prixPromo: rabais > 0 ? Math.round(prixUnitaire * (1 - rabais / 100) / 250) * 250 : null
        },
        pack: {
          actif: rabais > 0,
          pourcentage: rabais,
          prixPromo: rabais > 0 ? Math.round(prixPack * (1 - rabais / 100) / 250) * 250 : null
        },
        boite: {
          actif: rabais > 0,
          pourcentage: rabais,
          prixPromo: rabais > 0 ? Math.round(prixBoite * (1 - rabais / 100) / 250) * 250 : null
        }
      },
    ...
    <div className="space-y-6">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm">
        ...
        <p className="text-amber-700">
          ...
          Rang, Année, <strong>prix_unitaire</strong>, Rabais (%), Qte / pack
        </p>
      </div>
